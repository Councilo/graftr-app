...
const HANDLERS = {
  ...
  'admin-shops': () => require('../handlers/admin-shops'),
  ...
  'shop-handover': () => require('../handlers/shop-handover'),
  'shop-post-bag': () => require('../handlers/shop-post-bag'),
  'shop-profile': () => require('../handlers/shop-profile'),
  'shop-ready': () => require('../handlers/shop-ready'),
