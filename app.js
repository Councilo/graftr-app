...
function renderShopperBrowse() {
  ...
  const summaryBar = count > 0
    ...
    // a full-width bar spanning the column. 14px radius to match the Checkout
    // button rather than being a full pill.
